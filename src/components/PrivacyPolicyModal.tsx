      ...
      >
        ...
        <div className="p-6 sm:p-8 overflow-y-auto font-body text-sm text-charcoal/80 leading-relaxed space-y-8 custom-scrollbar">
          ...
          <div className="space-y-4">
            <p>
              This website is operated by the authorised marketing channel for Adarsh Savana Phase 2, a premium plotted community in North Bengaluru. We are committed to protecting the privacy of every visitor to this website and handling your personal information with care, transparency, and respect.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li>Responding to your enquiry about Adarsh Savana</li>
              <li>Processing brochure downloads and site visit scheduling</li>
              <li>Connecting you with the authorised Adarsh Savana sales team</li>
          ...
          <div className="space-y-4">
            ...
            <p>We may share your information with Adarsh Group and their authorised sales representatives for the sole purpose of fulfilling your enquiry and following up on your interest in this project.</p>
            <p>We do not sell, rent, or trade your personal data to any third parties for marketing purposes unrelated to Adarsh Savana or Adarsh Developers projects.</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p>For any privacy-related queries, please reach out to the Adarsh Savana sales team:</p>
            <ul className="list-disc list-inside space-y-2 text-charcoal/80 pl-2">
              ...
              <li><strong>RERA Reg. No.:</strong> Phase 1: EX/PRM/KA/RERA/1250/303/PR/221219/003613</li>
            </ul>
          </div>
        </div>
