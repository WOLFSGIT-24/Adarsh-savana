      ...
      >
        ...
        <div className="flex justify-between items-center p-6 sm:p-8 border-b border-navy-primary/5 bg-marble shrink-0">
          <div>
            ...
            <p className="font-body text-xs text-charcoal/60 mt-1 uppercase tracking-widest">Adarsh Savana</p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 sm:p-8 overflow-y-auto font-body text-sm text-charcoal/80 leading-relaxed space-y-8 custom-scrollbar">
          ...
          <div className="space-y-4">
            <p>
              By accessing and using this website, you agree to be bound by these Terms and Conditions. This website is operated by an authorised marketing partner for Adarsh Savana.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p>
              This website has been created for the sole purpose of providing information and generating enquiries for Adarsh Savana Phase 2, a premium plotted community in North Bengaluru. This is an authorised marketing website and operates in accordance with developer guidelines.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p>
              By submitting your contact details through any form on this website, you consent to being contacted by our team and/or the authorised Adarsh Savana sales team via phone, email, SMS, or WhatsApp regarding the project.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p>
              All content on this website including text, images, logos, and design is either owned by or licensed to Adarsh Group and their respective marketing partners. Unauthorised reproduction, distribution, or modification of any material on this site is strictly prohibited.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p><strong>Karnataka RERA Registration No:</strong> Phase 1: EX/PRM/KA/RERA/1250/303/PR/221219/003613</p>
          ...
          <div className="space-y-4">
            ...
            <p>
              In no event shall Adarsh Group or their authorised marketing partners be liable for any direct, indirect, incidental, or consequential damages arising from the use of this website or reliance on any information provided herein.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="list-none space-y-1 mt-2">
              <li><strong>Project:</strong> Adarsh Savana Phase 2</li>
              <li><strong>Developer:</strong> Adarsh Developers / Adarsh Group</li>
              <li><strong>Email:</strong> Hello@therealconnect.co.in</li>
              <li><strong>Location:</strong> Sales Lounge: Adarsh Savana, Sy. No.100, Chapparkallu Main Road, Hegganahalli, Devanahalli, Bengaluru - 562110</li>
            </ul>
          </div>
        </div>
