        ...
        <div id="lead-capture-section" className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="text-center lg:text-left">
              <span className="font-body text-xs font-bold text-champagne uppercase tracking-[0.25em] block mb-4">
                ADARSH SAVANA — PHASE 2
              </span>
              <h2 className="font-display text-3xl sm:text-4xl text-white font-semibold leading-tight drop-shadow-sm mb-4">
            ...
            <div className="bg-black/25 backdrop-blur-md p-6 sm:p-8 rounded-lg space-y-5 border border-white/10 shadow-2xl">
              ...
              <ul className="space-y-3 font-body text-xs sm:text-sm text-white/90">
                <li className="flex justify-between items-center border-b border-white/5 pb-2.5">
                  <span className="font-semibold text-white">24 ACRES</span>
                  <span className="text-white/70 text-xs sm:text-sm">Phase 2 Development</span>
                </li>
                <li className="flex justify-between items-center border-b border-white/5 pb-2.5">
                  <span className="font-semibold text-white">250+ UNITS</span>
                  <span className="text-white/70 text-xs sm:text-sm">Premium Plotted Community</span>
                </li>
                <li className="flex justify-between items-center border-b border-white/5 pb-2.5">
                  <span className="font-semibold text-white">1200 SQ.FT. ONWARDS</span>
                  <span className="text-white/70 text-xs sm:text-sm">Plot Sizes</span>
                </li>
                <li className="flex justify-between items-center border-b border-white/5 pb-2.5">
                  <span className="font-semibold text-white">₹99.99 LAKHS ONWARDS*</span>
                  <span className="text-white/70 text-xs sm:text-sm">Starting Price</span>
                </li>
                <li className="flex justify-between items-center border-b border-white/5 pb-2.5">
                  <span className="font-semibold text-white">60,000 SQ.FT.</span>
                  <span className="text-white/70 text-xs sm:text-sm">Clubhouse</span>
                </li>
                <li className="flex justify-between items-center pb-1">
                  <span className="font-semibold text-white">60+ AMENITIES</span>
                  <span className="text-white/70 text-xs sm:text-sm">Lifestyle & Recreation</span>
                </li>
              </ul>
            </div>
          </div>
                ...
                <>
                  <div className="mb-8">
                    ...
                    <p className="font-body text-xs text-gray-text mt-1">
                      Experience the project, understand the floor plans and explore the lifestyle that Adarsh Savana Phase 2 has to offer.
                    </p>
                  </div>
