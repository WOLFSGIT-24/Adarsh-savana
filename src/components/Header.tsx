...
export default function Header({ onOpenBooking, onToggleAdmin, isAdminActive }: HeaderProps) {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const sections = ["overview", "master-plan", "amenities", "gallery", "location", "snapshots"];
  ...
  return (
    <>
      <div className="fixed top-0 left-0 w-full z-50 flex flex-col">
        {/* Top Announcement Strip removed */}
        
        <header
          className="w-full h-20 bg-white border-b border-navy-primary/10 shadow-sm transition-all duration-300"
        >
          ...
          >
            <img
              ...
              className="h-14 md:h-16 py-1 w-auto object-contain group-hover:scale-105 transition-transform duration-300"
            />
          </a>
